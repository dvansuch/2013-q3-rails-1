...
get "/reposts/1" do
	...
	@summary= "A complex object creation can clutter a controller. It's better to move it into a dedicated method of the corresponding model."
  	@content= "http://blog.8thcolor.com/2013/07/spring-cleanup-for-object-creation-in-rails/"
  halt erb(:repost1)
end
...
get "/reposts/2" do
	...
	@content= "http://cloudinary.com/blog/how_to_support_webp_images_save_bandwidth_and_improve_user_performance"
  halt erb(:repost1)
end
